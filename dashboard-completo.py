...
# GRÁFICO 7 - Tendência Diária de Saída de OS
tendencia_saida = df_saida_filtrado[df_saida_filtrado["Saída"].notna()].groupby("Saída")["Boletim"].count().reset_index()
...
st.subheader("Gráfico 7 - Tendência Diária de Saída de OS")
